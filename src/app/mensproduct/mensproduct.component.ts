...
export class MensproductComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (storedProducts) {
      ...
      this.products = allProducts.filter((product: any) => product.gender === 'male');
      this.filteredProducts = [...this.products];
      let categories = this.filterService.getCategoriesByGender('male');
  ...
  goToProductDetails(productId: number) {
    this.router.navigate([`/menproduct/${productId}`]);
  }
